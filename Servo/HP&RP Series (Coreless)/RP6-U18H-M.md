...
| Interface | dA2007-3Pin |
| Case Material | CNC aluminum alloy housing |
| Dimensions (W×H×D) | 33.5×21×27.3 mm |
| Weight | 45 g |
...
| --- | --- |
| Max Stall Torque | 1.76 N·m (18 kg·cm) |
| Max Continuous Torque | 0.88 N·m (9 kg·cm) |
| Rated Torque | 0.27 N·m(2.8 kg-cm) |
| Rated Speed | 64 rpm (0.156 sec@60°) |
| No‑load Speed | 86 rpm (0.116 sec@60°) |
...
<img src="./UART_image/U18特性曲线图.png" alt="U18过载曲线" style="zoom:50%;" />

### 3.4 Overload Graph

<img src="./UART_image/U18过载曲线.png" alt="U18过载曲线" style="zoom: 50%;" />
...
| <img src="./UART_image/U18_3D图.png" alt="U18_3D图" style="zoom:50%;" /> |
| :----------------------------------------------------------: |
