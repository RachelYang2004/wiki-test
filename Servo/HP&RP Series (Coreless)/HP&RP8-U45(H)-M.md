# UART Bus Servo 45KG Series 

<img src="./UART_image/U45产品图片.png" alt="U45产品图片" style="zoom:67%;" />
...
| --- | --- |
| Max Stall Torque | 4.41 N·m (45 kg·cm) |
| Max Continuous Torque | 1.67 N·m (17 kg·cm) |
| Rated Torque | 0.54 N·m (5.5 kg·cm) |
| Rated Speed | 64 rpm (0.156 sec@60°) |
| No‑load Speed | 90 rpm (0.110 sec@60°) |
...
<img src="./UART_image/U45特性曲线图.png" alt="U45过载曲线" style="zoom: 50%;" />

### 3.4 Overload Graph

<img src="./UART_image/U45过载曲线.png" alt="U45过载曲线" style="zoom:50%;" />
...
| <img src="./UART_image/U45_3D图.png" alt="U45_3D图" style="zoom:50%;" /> |
| :----------------------------------------------------------: |

### 4.2 Interface Definition

| <img src="./UART_image/U45接口图.png" alt="U45接口图" style="zoom: 50%;" /> |
| :----------------------------------------------------------: |
...
| <img src="./UART_image/U45串联.png" alt="U45串联" style="zoom: 50%;" /> |
| :----------------------------------------------------------: |

- **Parallel Connection**


| <img src="./UART_image/U45并联.png" alt="U45并联" style="zoom:50%;" /> |
| :----------------------------------------------------------: |
...
| ![U45单轴安装](./UART_image/U45单轴安装.png) |
| :------------------------------------------: |

-  **Dual-shaft**

  | <img src="./UART_image/U45双轴安装.png" alt="U45双轴安装" style="zoom:50%;" /> |
  | :----------------------------------------------------------: |
