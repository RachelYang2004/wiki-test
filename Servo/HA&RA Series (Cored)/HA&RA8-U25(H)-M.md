...
| Rated Torque | 0.44 N·m (3.4 kg·cm) |
| Rated Speed | 18 rpm (0.556 sec@60°) |
...
<img src="./UART_image/U25特性曲线.png" alt="U15过载曲线" style="zoom: 50%;" />

### 3.4 Overload Graph

<img src="./UART_image/U25过载曲线.png" alt="U25过载曲线" style="zoom: 50%;" />
...
| <img src="./UART_image/U25_3D图.png" alt="U25_3D图" style="zoom:50%;" /> |
| :----------------------------------------------------------: |

### 4.2 Interface Definition

| <img src="./UART_image/U25接口图.png" alt="U25接口图" style="zoom:50%;" /> |
| :----------------------------------------------------------: |
...
| <img src="./UART_image/U25串联.png" alt="U25串联" style="zoom: 50%;" /> |
| :----------------------------------------------------------: |

- **Parallel Connection**


| <img src="./UART_image/U25并联.png" alt="U25并联" style="zoom:50%;" /> |
| :----------------------------------------------------------: |
...
| <img src="./UART_image/U25单轴安装.png" alt="U25单轴安装" style="zoom:67%;" /> |
| :----------------------------------------------------------: |

-  **Dual-shaft**

  | <img src="./UART_image/U25双轴安装.png" alt="U25双轴安装" style="zoom:67%;" /> |
  | :----------------------------------------------------------: |
