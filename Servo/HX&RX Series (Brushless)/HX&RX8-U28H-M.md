# UART Bus Servo 28KG Series 

<img src="./UART_image/U28产品图.png" alt="U28产品图" style="zoom: 50%;" />
...
| --- | --- |
| Max Stall Torque | 2.74 N·m (28 kg·cm) |
| Max Continuous Torque | 1.18 N·m (12 kg·cm) |
| Rated Torque | 0.44 N·m (4.5 kg·cm) |
| Rated Speed | 116 rpm (0.086 sec@60°) |
| No‑load Speed | 142 rpm (0.070 sec@60°) |
...
<img src="./UART_image/U28特性曲线图.png" alt="U28过载曲线" style="zoom:50%;" />

### 3.4 Overload Graph

<img src="./UART_image/U28过载曲线图.png" alt="U28过载曲线" style="zoom:50%;" />
...
| <img src="./UART_image/U28_3D图.png" alt="U28_3D图" style="zoom:67%;" /> |
| :----------------------------------------------------------: |

### 4.2 Interface Definition

| <img src="./UART_image/U28接口图.png" alt="U28接口图" style="zoom: 50%;" /> |
| :----------------------------------------------------------: |
...
| <img src="./UART_image/U28串联.png" alt="U28串联" style="zoom: 50%;" /> |
| :----------------------------------------------------------: |

- **Parallel Connection**

| <img src="./UART_image/U28并联.png" alt="U28并联" style="zoom:50%;" /> |
| :----------------------------------------------------------: |
...
| ![U28单轴安装](./UART_image/U28单轴安装.png) |
| :------------------------------------------: |

-  **Dual-shaft**

  | <img src="./UART_image/U28双轴安装.png" alt="U28双轴安装" style="zoom:50%;" /> |
  | :----------------------------------------------------------: |
