...
<img src="./UART_image/U29特性曲线图.png" alt="U29过载曲线" style="zoom:50%;" />

### 3.4 Overload Graph

<img src="./UART_image/U29过载曲线图.png" alt="U28过载曲线" style="zoom:50%;" />
...
| <img src="./UART_image/U29_3D图.png" alt="U15单轴" style="zoom:67%;" /> |
| :----------------------------------------------------------: |

### 4.2 Interface Definition

| <img src="./UART_image/U29接口图.png" alt="U15接口图" style="zoom: 50%;" /> |
| :----------------------------------------------------------: |
...
| <img src="./UART_image/U29串联.png" alt="U15串联" style="zoom: 50%;" /> |
| :----------------------------------------------------------: |

- **Parallel Connection**

| <img src="./UART_image/U29并联.png" alt="U15并联" style="zoom:50%;" /> |
| :----------------------------------------------------------: |
...
| <img src="./UART_image/U29单轴安装.png" alt="U29单轴安装" style="zoom: 50%;" /> |
| :----------------------------------------------------------: |

-  **Dual-shaft**

  | <img src="./UART_image/U29双轴安装.png" alt="U29双轴安装" style="zoom:50%;" /> |
  | :----------------------------------------------------------: |
