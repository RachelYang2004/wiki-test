...
![img](images/servo-communication/4.png)
...
![img](images/servo-communication/open-project.png)

![img](images/servo-communication/main.png)

3 . **代码编译**

![img](images/servo-communication/compile.png)

日志输出：编译成功

![img](images/servo-communication/compile-success.png)

4 . **将STLinkV2与电脑的USB相连接**

5 . **将固件下载到STM32**

![img](images/servo-communication/download.png)

固件载入到STM32 Flash成功的日志输出

![img](images/servo-communication/flash-load-finished.png)
...
![img](images/servo-communication/serial-config.png)
...
![img](images/servo-communication/resetbt.png)

10 . **查看串口调试助手上的日志信息**

![img](images/servo-communication/serial-logging.png)
